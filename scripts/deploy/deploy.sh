...
echo " Builds 3: dist (público/EXPO_PUBLIC_APP_MODE=public) + dist-admin (admin) + dist-student (student)"
echo " Navegadores nuevos: PublicNavigator + AdminNavigator + StudentNavigator  (SimpleAuthProvider + SimpleAuthGate)"
echo "============================================="
echo ""
